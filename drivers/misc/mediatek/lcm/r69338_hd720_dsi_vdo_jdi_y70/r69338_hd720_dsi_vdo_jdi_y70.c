...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0XC7, 30,  {0x00,0x05,0x0F,0x16,0x24, //GAMMA 1
			     0x32,0x3D,0x4D,0x32,0x3B,
				 0x48,0x57,0x63,0x69,0x76,
				 0x00,0x05,0x0F,0x16,0x24,
				 0x32,0x3D,0x4D,0x32,0x3B,
				 0x48,0x57,0x63,0x69,0x76}},
	{0XC8, 19,  {0x00,0x00,0x00,0x00,0x00, //GAMMA 2
				 0xFC,0x00,0x00,0x00,0x00,
				 0x00,0xFC,0x00,0x00,0x00,
				 0x00,0x00,0xFC,0x00}},
	{0XB8,  6,  {0x07,0x90,0x1E,0x00,0x40,0x32}}, //Backlight control 1
	{0XB9,  6,  {0x07,0x8C,0x3C,0x20,0x2D,0x87}}, //Backlight control 2
	{0XBA,  6,  {0x07,0x82,0x3C,0x10,0x3C,0xB4}}, //Backlight control 3
	{0XCE, 24,  {0x7D,0x40,0x43,0x49,0x55, 		  //Backlight control 4
				 0x62,0x71,0x82,0x94,0xA8,
				 0xB9,0xCB,0xDB,0xE9,0xF5,
				 0xFC,0xFF,0x02,0x00,0x04,
				 0x04,0x44,0x04,0x01}},
	{0XBB,  3,  {0x01,0x1E,0x14}},	//SRE control 1
	{0XBC,  3,  {0x01,0x50,0x32}},	//SRE control 2
	{0XBD,  3,  {0x00,0xB4,0xA0}},	//SRE control 3
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0XB0, 1, {0X04}},		//Test command
	{0XEC, 19, {0x29,0x00,0x2C,0x2B,0x01,
				0x00,0x00,0x00,0x00,0x00,
				0x00,0x00,0x00,0x00,0x00,
				0x00,0x07,0x09,0x00}},
	{0XEE, 14, {0X1C,0X02,0X02,0X03,0X00, // TP Countermeasure(Trial) (2)
				0X10,0X00,0X02,0X00,0X00,
				0X00,0X00,0X00,0X03}},
	{0XC7, 30, {0x00,0x0A,0x16,0x20,0x2C,
