...
#define GPIO_NFC_VEN  GPIO_NFC_VENB_PIN  //(137| 0x80000000)
#define GPIO_NFC_IRQ  GPIO_IRQ_NFC_PIN   //(132 | 0x80000000)
#define GPIO_NFC_WAKE GPIO_NFC_MODE  //(136 | 0x80000000)
                  ...
                  size_t count, loff_t *offset)
{
    ...
    **/
#if defined (BCM2079X_MTK_PLATFORM)	
    bcm2079x_dev->client->adapter->retries = 5;
