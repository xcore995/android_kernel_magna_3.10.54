...
//====================================================================
// Function : Dummy_NotifyHandler
// Description
//   - Do additional processing for notification
//   - ( ex. reduce sensitivity in call, change active area for quick cover window )
//   - "common_driver" will not block duplicated notify from CFW, so you should do if you need.
//====================================================================
