...
#else
/*TS 522*/
#define TCC353X_REMAP_TYPE 	0x01		/* tmm cspi only */ 
#define TCC353X_BUFF_A_START 	0x0000C000
#define TCC353X_BUFF_A_END 	0x00023F57	/* inside driver fix */
#define TCC353X_BUFF_B_START 	0x00018000
#define TCC353X_BUFF_B_END 	0x00019f93
#define TCC353X_BUFF_C_START 	0x00018000
#define TCC353X_BUFF_C_END 	0x00019f93
...
#define TCC353X_STREAM_BUFFER_SIZE	(188*3840)
#else
