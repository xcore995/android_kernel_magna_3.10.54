...
#define ECS_IOCTL_SET_YPR               _IOW(MSENSOR, 0x29, int[26])		//AKM_Eddie.Park 20140424 -For AK09911
#define ECS_IOCTL_GET_DELAY             _IOR(MSENSOR, 0x30, int64_t[3])		//AKM_Eddie.Park 20140424 -For AK09911
#define	ECS_IOCTL_GET_LAYOUT			_IOR(MSENSOR, 0x31, char)			 //AKM_Eddie.Park 20140424 -For AK09911 
