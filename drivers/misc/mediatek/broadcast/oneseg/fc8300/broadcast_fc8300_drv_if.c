...
int    broadcast_fc8300_drv_start(void)
{
    int rc;
    rc = OK;
...
static void broadcast_fc8300_drv_if_get_oneseg_sig_info(fc8300Status_t *pst, struct broadcast_dmb_control_info *pInfo, s32 brd_type)
{
    int ber;
    int per;
    int cn;
