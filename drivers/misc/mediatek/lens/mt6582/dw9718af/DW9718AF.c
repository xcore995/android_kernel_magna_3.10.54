...
//                                                                                
extern int dw9718_af_current_on;
//                                                                               
...
static int DW9718AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    long i4RetValue = 0;
    //                                                                                
    char puSendCmd2[2] = {0x01,0x3F};//0x39};
    char puSendCmd3[2] = {0x05,0x0C};//0x65};
    //                                                                                
...
//                                                                                
	...
	{
	 DW9718AFDB("[DW9718AF] POPO af_current_on the device is opened \n"); 
	 return 0;
	}
#endif
//                                                                               
