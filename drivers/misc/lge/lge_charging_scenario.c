...
static struct batt_temp_table chg_temp_table[CHG_MAXIDX] = {
	{ INT_MIN,       -11,    CHG_BATTEMP_BL_M11,  "under -10" },	// batt_temp < -10
	{    -10,         -5,    CHG_BATTEMP_M10_M5,  "-10 ~ -5"  },	// -10 <= batt_temp <= -5
	{     -4,         41,     CHG_BATTEMP_M4_41,   "-4 ~ 41"  },	// -5 < batt_temp < 42
	{     42,         45,     CHG_BATTEMP_42_45,   "42 ~ 45"  },	// 42 <= batt_temp <= 45
	{     46,         52,     CHG_BATTEMP_46_52,   "46 ~ 52"  },	// 45 < batt_temp <= 52
	{     53,         55,     CHG_BATTEMP_53_55,   "53 ~ 55"  },	// 52 < batt_temp <= 55
	{     56,    INT_MAX,     CHG_BATTEMP_AB_OT,   "over 55"  },	// 55 < batt_temp
};
...
static enum lge_battemp_states determine_batt_temp_state(int batt_temp)
{
	...
	/* Unknown temperature. Concider normal temperature */
	if (cnt < 0)
		cnt = 2;
