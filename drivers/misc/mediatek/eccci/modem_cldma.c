...
static int md_cd_send_runtime_data(struct ccci_modem *md, unsigned int sbp_code)
{
	...
	printk("jjm_debug : md_cd_send_runtime_data : runtime.feature_4_val[0] = %s, runtime.feature_4_val[1] = %s, runtime.feature_4_val[2] = %s, runtime.feature_4_val[3] = %s", (char *)(&runtime->feature_4_val[0]), (char *)(&runtime->feature_4_val[1]), (char *)(&runtime->feature_4_val[2]), (char *)(&runtime->feature_4_val[3]));
	/* sbp_interface */
	#endif
#endif
    // CCCI debug
