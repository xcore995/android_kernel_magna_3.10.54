...
void tunerbb_drv_hw_setting(void)
{
    ...
    //DTV LDO EN
    print_log(0,"[1seg][MTK][YKTEST_CLK_26M_v1] GPIO_FULL_SEG_LDO_EN Port request!!!\n");
    ret = mt_set_gpio_mode(GPIO_FULL_SEG_LDO_EN, GPIO_FULL_SEG_LDO_EN_M_GPIO);
    print_log(0,"[1seg][MTK] mt_set_gpio_mode(GPIO_FULL_SEG_LDO_EN, GPIO_FULL_SEG_LDO_EN_M_GPIO) : (%d)\n", ret);
    ret = mt_set_gpio_pull_enable(GPIO_FULL_SEG_LDO_EN, GPIO_PULL_ENABLE);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_enable(GPIO_FULL_SEG_LDO_EN, GPIO_PULL_ENABLE) : (%d)\n", ret);
    ret = mt_set_gpio_pull_select(GPIO_FULL_SEG_LDO_EN,GPIO_PULL_DOWN);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_select(GPIO_FULL_SEG_LDO_EN,GPIO_PULL_DOWN) : (%d)\n", ret);

    //PWR Enable
    print_log(0,"[1seg][MTK] GPIO_ISDBT_PWR_EN Port request!!!\n");
    ret = mt_set_gpio_mode(GPIO_FULL_SEG_EN, GPIO_FULL_SEG_EN_M_GPIO);
    print_log(0,"[1seg][MTK] mt_set_gpio_mode(GPIO_FULL_SEG_EN, GPIO_1SEG_EN_M_GPIO) : (%d)\n", ret);
    ret = mt_set_gpio_pull_enable(GPIO_FULL_SEG_EN, GPIO_PULL_ENABLE);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_enable(GPIO_FULL_SEG_EN, GPIO_PULL_ENABLE) : (%d)\n", ret);
    ret = mt_set_gpio_pull_select(GPIO_FULL_SEG_EN,GPIO_PULL_DOWN);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_select(GPIO_FULL_SEG_EN, GPIO_PULL_DOWN) : (%d)\n", ret);

    udelay(50);

    ret = mt_set_gpio_dir(GPIO_FULL_SEG_LDO_EN, GPIO_DIR_OUT);
    print_log(0,"[1seg][MTK] mt_set_gpio_dir(GPIO_FULL_SEG_LDO_EN, GPIO_DIR_OUT) : (%d)\n", ret);
    ret = mt_set_gpio_out(GPIO_FULL_SEG_LDO_EN, GPIO_OUT_ZERO);
    print_log(0,"[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_LDO_EN, GPIO_OUT_ZERO) : (%d)\n", ret);
    ...
    print_log(0,"[1seg][MTK] mt_set_gpio_mode(GPIO_FULL_SEG_INT, GPIO_FULL_SEG_INT_M_GPIO) : (%d)\n", ret);
    ...
    print_log(0,"[1seg][MTK] mt_set_gpio_dir(GPIO_FULL_SEG_INT, GPIO_DIR_IN) : (%d)\n", ret);

    // Reset
    print_log(0,"[1seg][MTK] GPIO_ISDBT_RST Port request set zero!!!\n");
    udelay(50);

    ret = mt_set_gpio_mode(GPIO_FULL_SEG_RESET_N, GPIO_FULL_SEG_RESET_N_M_GPIO);
    print_log(0,"[1seg][MTK] mt_set_gpio_mode(GPIO_FULL_SEG_RESET_N,  GPIO_FULL_SEG_RESET_N_M_GPIO) : (%d)\n", ret);

    ret = mt_set_gpio_pull_enable(GPIO_FULL_SEG_RESET_N, GPIO_PULL_ENABLE);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_enable(GPIO_FULL_SEG_RESET_N, GPIO_PULL_ENABLE) : (%d)\n", ret);

    ret = mt_set_gpio_pull_select(GPIO_FULL_SEG_RESET_N,GPIO_PULL_DOWN);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_select(GPIO_FULL_SEG_RESET_N,GPIO_PULL_DOWN) : (%d)\n", ret);

    ret = mt_set_gpio_dir(GPIO_FULL_SEG_RESET_N, GPIO_DIR_OUT);
    print_log(0,"[1seg][MTK] mt_set_gpio_dir(GPIO_FULL_SEG_RESET_N, GPIO_DIR_OUT) : (%d)\n", ret);

    ret = mt_set_gpio_out(GPIO_FULL_SEG_RESET_N, GPIO_OUT_ZERO);
    print_log(0,"[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_RESET_N, GPIO_OUT_ZERO) : (%d)\n", ret);


    //SPI MISO
    ret = mt_set_gpio_pull_enable(GPIO82|0x80000000, GPIO_PULL_ENABLE);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_enable(GPIO82|0x80000000, GPIO_PULL_ENABLE) : (%d)\n", ret);
    ret = mt_set_gpio_pull_select(GPIO82|0x80000000,GPIO_PULL_DOWN);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_select(GPIO82|0x80000000,GPIO_PULL_DOWN) : (%d)\n", ret);

    //SPI MOSI
    ret = mt_set_gpio_pull_enable(GPIO83|0x80000000, GPIO_PULL_ENABLE);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_enable(GPIO83|0x80000000, GPIO_PULL_ENABLE) : (%d)\n", ret);
    ...
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_enable(GPIO81|0x80000000, GPIO_PULL_ENABLE) : (%d)\n", ret);
    ret = mt_set_gpio_pull_select(GPIO81|0x80000000,GPIO_PULL_DOWN);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_select(GPIO81|0x80000000,GPIO_PULL_DOWN) : (%d)\n", ret);

    //SPI CS
    ret = mt_set_gpio_pull_enable(GPIO80|0x80000000, GPIO_PULL_ENABLE);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_enable(GPIO80|0x80000000, GPIO_PULL_ENABLE) : (%d)\n", ret);
    ret = mt_set_gpio_pull_select(GPIO80|0x80000000,GPIO_PULL_DOWN);
    print_log(0,"[1seg][MTK] mt_set_gpio_pull_select(GPIO80|0x80000000,GPIO_PULL_DOWN) : (%d)\n", ret);
#else //CONFIG_ARCH_MT6582
    if(gpio_request(GPIO_ISDBT_PWR_EN, "ISDBT_EN"))
        print_log(0,"[1seg] GPIO_ISDBT_PWR_EN Port request error!!!\n");
    udelay(50);
...
// MediaTek platform
    print_log(0, "[FC8300][MTK] isdbt_hw_init\n");

    //Interrupt
    ret = mt_set_gpio_pull_enable(GPIO_FULL_SEG_INT, GPIO_PULL_ENABLE);
    print_log(0, "[1seg][MTK] mt_set_gpio_pull_enable(GPIO_1SEG_INT, GPIO_PULL_ENABLE)(%d)\n", ret);

    ret = mt_set_gpio_pull_select(GPIO_FULL_SEG_INT,GPIO_PULL_UP);
    print_log(0, "[1seg][MTK] mt_set_gpio_pull_select(GPIO_1SEG_INT,GPIO_PULL_UP)(%d)\n", ret);

    //SPI MISO
    ret = mt_set_gpio_pull_enable(GPIO82|0x80000000, GPIO_PULL_DISABLE);
    print_log(0, "[1seg][MTK] mt_set_gpio_pull_enable(GPIO82|0x80000000, GPIO_PULL_DISABLE)(%d)\n", ret);

    //SPI MOSI
    ret = mt_set_gpio_pull_enable(GPIO83|0x80000000, GPIO_PULL_DISABLE);
    print_log(0, "[1seg][MTK] mt_set_gpio_pull_enable(GPIO83|0x80000000, GPIO_PULL_DISABLE)(%d)\n", ret);

    //SPI CLK
    ret = mt_set_gpio_pull_enable(GPIO81|0x80000000, GPIO_PULL_DISABLE);
    print_log(0, "[1seg][MTK] mt_set_gpio_pull_enable(GPIO81|0x80000000, GPIO_PULL_DISABLE)(%d)\n", ret);

    //SPI CS
    ret = mt_set_gpio_pull_enable(GPIO80|0x80000000, GPIO_PULL_DISABLE);
    print_log(0, "[1seg][MTK] mt_set_gpio_pull_enable(GPIO80|0x80000000, GPIO_PULL_DISABLE)(%d)\n", ret);
    ret = mt_set_gpio_mode(GPIO80|0x80000000, GPIO_MODE_01);     //GPIO_MATV_I2S_WS_PIN_M_SPI_CS   GPIO_MODE_01
    print_log(0, "[1seg][MTK] mt_set_gpio_mode(GPIO80|0x80000000, GPIO_MODE_01)(%d)\n", ret);

    ret = mt_set_gpio_pull_enable(GPIO80|0x80000000, GPIO_PULL_ENABLE);
    print_log(0, "[1seg][MTK] mt_set_gpio_pull_enable(GPIO80|0x80000000, GPIO_PULL_ENABLE)(%d)\n", ret);

    ret = mt_set_gpio_pull_select(GPIO80|0x80000000,GPIO_PULL_UP);
    print_log(0, "[1seg][MTK] mt_set_gpio_pull_select(GPIO80|0x80000000,GPIO_PULL_DOWN)(%d)\n", ret);


    ret = mt_set_gpio_dir(GPIO80|0x80000000, GPIO_DIR_IN);
    print_log(0, "[1seg][MTK] mt_set_gpio_dir(GPIO80|0x80000000, GPIO_DIR_IN)(%d)\n", ret);
    ...
    msWait(10);
    ret = mt_set_gpio_out(GPIO_FULL_SEG_RESET_N, GPIO_OUT_ONE);
    print_log(0, "[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_RESET_N, GPIO_OUT_ONE)(%d)\n", ret);

    ret = mt_set_gpio_out(GPIO_FULL_SEG_LDO_EN, GPIO_OUT_ONE);
    print_log(0, "[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_LDO_EN, GPIO_OUT_ONE)(%d)\n", ret);
    msWait(10);
    ret = mt_set_gpio_out(GPIO_FULL_SEG_EN, GPIO_OUT_ONE);
    print_log(0, "[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_EN, GPIO_OUT_ONE)(%d)\n", ret);
    msWait(10);
    ret = mt_set_gpio_out(GPIO_FULL_SEG_RESET_N, GPIO_OUT_ZERO);
    print_log(0, "[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_RESET_N, GPIO_OUT_ZERO)(%d)\n", ret);

    msWait(10);
    ret = mt_set_gpio_out(GPIO_FULL_SEG_RESET_N, GPIO_OUT_ONE);    // current leackage
    print_log(0, "[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_RESET_N, GPIO_OUT_ONE)(%d)\n", ret);
    msWait(10);
#else //CONFIG_ARCH_MT6582
...
void tunerbb_drv_hw_deinit(void)
{
    ...
    print_log(0, "[1seg][MTK] isdbt_hw_deinit overrun count = %d\n", overrun_count);
    ...
    ret = mt_set_gpio_dir(GPIO_FULL_SEG_EN, GPIO_DIR_OUT);
    print_log(0, "[1seg][MTK] mt_set_gpio_dir(GPIO_FULL_SEG_EN, GPIO_DIR_OUT)(%d)\n", ret);

    ret = mt_set_gpio_out(GPIO_FULL_SEG_EN, GPIO_OUT_ZERO);
    print_log(0, "[1seg][MTK] mt_set_gpio_out(GPIO_FULL_SEG_EN, GPIO_OUT_ZERO)(%d)\n", ret);
    ...
    ret = mt_set_gpio_pull_select(GPIO83|0x80000000,GPIO_PULL_DOWN);
    print_log(0, "[1seg][MTK] mt_set_gpio_pull_select(GPIO83|0x80000000,GPIO_PULL_DOWN)(%d)\n", ret);
    ...
    print_log(0, "[1seg][MTK] mt_set_gpio_mode(GPIO80|0x80000000, GPIO_MODE_00)(%d)\n", ret);
    ...
    print_log(0, "[1seg][MTK] mt_set_gpio_dir(GPIO80|0x80000000, GPIO_DIR_OUT)(%d)\n", ret);

    ret = mt_set_gpio_out(GPIO80|0x80000000, GPIO_OUT_ZERO);
    print_log(0, "[1seg][MTK] mt_set_gpio_out(GPIO80|0x80000000, GPIO_OUT_ZERO)(%d)\n", ret);
...
int tunerbb_drv_fc8300_init(int mode)
{
    ...
    print_log(0, "[1seg][MTK] FC8300 BBM_PROBE res : %d \n", res);
    //fc8300_if_test();

    if(res)
        print_log(0, "[1seg][MTK] FC8300 Initialize Fail : %d \n", res);

    res |= bbm_com_init(NULL, DIV_BROADCAST);
    res |= bbm_com_tuner_select(NULL, DIV_BROADCAST, FC8300_TUNER, mode);

    if(res)
        print_log(0, "[1seg][MTK] IOCTL_ISDBT_POWER_ON FAIL \n");
    else
        print_log(0, "[1seg][MTK] IOCTL_ISDBT_POWER_OK \n");
