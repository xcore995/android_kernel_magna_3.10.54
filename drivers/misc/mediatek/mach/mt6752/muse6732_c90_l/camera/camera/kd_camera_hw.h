...
#endif
#endif
#define GPIO_CAMERA_CMRST_PIN_MAIN         (GPIO123 | 0x80000000)
#define GPIO_CAMERA_CMRST_PIN_MAIN_M_GPIO    GPIO_MODE_00

#define GPIO_CAMERA_CMRST_PIN_SUB         (GPIO33 | 0x80000000)
#define GPIO_CAMERA_CMRST_PIN_SUB_M_GPIO    GPIO_MODE_00

#define CAMERA_CMRST_PIN            GPIO_CAMERA_CMRST_PIN_MAIN
#define CAMERA_CMRST_PIN_M_GPIO     GPIO_CAMERA_CMRST_PIN_MAIN_M_GPIO

#define CAMERA_CMPDN_PIN            GPIO_CAMERA_INVALID
#define CAMERA_CMPDN_PIN_M_GPIO     GPIO_CAMERA_INVALID
 
//FRONT sensor
#define CAMERA_CMRST1_PIN           GPIO_CAMERA_CMRST_PIN_SUB
#define CAMERA_CMRST1_PIN_M_GPIO    GPIO_CAMERA_CMRST_PIN_SUB_M_GPIO
